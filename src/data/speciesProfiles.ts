...
export const SPECIES_PROFILES: Record<SpeciesKey, SpeciesProfile> = {
  ...
  octopus: {
    ...
    factoryWarning:
      '⚠️ 严禁回“随便/你看着办”，会疯狂喷墨并推演 18 种坏结局。',
    bestPartner: {
      key: 'chameleon',
      name: '变色龙体',
